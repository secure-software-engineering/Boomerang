 ...
 *       in the boomerangPDS module as well. In an ideal world (pun not
 *       intended), this would be part of the TestingFramework class, which is
 *       part of the testCore maven module. However, this class needs access to
 *       the BoomerangOptions class (which in turn refers to other classes)
 *       that is part of the boomerangPDS maven module. Hence, this would lead
 *       to a cyclic dependency testCore <-> boomerangPDS.
