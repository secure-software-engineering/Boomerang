...
class OpalInstanceFieldRef(val base: TacLocal, val fieldType: org.opalj.br.Type, val fieldName: String, method: OpalMethod, unbalanced: ControlFlowGraph.Edge = null) extends Val(method, unbalanced) {
  ...
  override def getArrayAllocationSize: Val = throw new RuntimeException("Instance field ref is not an array allocation val")

  override def isNull: Boolean = false

  override def isStringConstant: Boolean = false

  override def getStringValue: String = throw new RuntimeException("Instance field ref is not a String constant")
  ...
  override def getInstanceOfOp: Val = throw new RuntimeException("Instance field ref is not an instanceOf expression")

  override def isLengthExpr: Boolean = false

  override def getLengthOp: Val = throw new RuntimeException("Instance field ref is not a length expression")
  ...
  override def getIntValue: Int = throw new RuntimeException("Instance field ref is not an int constant")

  override def getLongValue: Long = throw new RuntimeException("Instance field ref is not a long constant")
